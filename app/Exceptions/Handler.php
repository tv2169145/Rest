...
//           dd($modelName);
        ...
        if ($exception instanceof MethodNotAllowedHttpException) {
            return $this->errorResponse('The method for the request is invalid cannot be found', 405);
        }
    ...
    {
        //--- 判斷是request是來自網頁 或 api
        //--- $request->acceptsHtml() 是否來自網頁
        //--- $request->acceptsJson() 是否來自api
        //--- collect($request->route()->middleware())->contains('web'); 是否經過"web"中介
